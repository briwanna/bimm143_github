...
we are going to use the `gage` package for pathway analysis. Once we have a list of enriched pathways, we're going to use the `pathview` package to draw pathway diagrams, shading the molecules in the pathway by their degree of up/down-regulation.
...
![Figure 3 JAK STAT Signaling Pathway](hsa04630.pathview.png)

![Figure 4 Steroid Hormone Biosynthesis](hsa00140.pathview.png)

![Figure 5 Lysosome](hsa04142.pathview.png)

![Figure 6 Notch Signaling Pathway](hsa04330.pathview.png)
